...
console.log("sdd",objectData)
  return (
    ...
    <div  className='hover:bg-[#A8A4FF] bg-[#635FC7] cursor-pointer absolute bottom-0 mb-24 rounded-r-full w-14' onClick={()=>dispatch(openNavbar(true))}>
    ...
    <div className={open===true?'bg-[#2B2C37]  flex justify-between flex-col absolute w-72 h-screen  border-r-[1px] border-r-[#3E3F4E]':'hidden'}>
     ...
     <div className='hover:bg-[#A8A4FF]   rounded-r-full w-64' onClick={()=>dispatch(allboardData(data))}>
