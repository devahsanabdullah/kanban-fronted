...
import {openNavbar,reload,openCreateBoard} from '../../services/action/action'
...
const handleOpen=()=>{
  ...
  return (
    ...
    <div  className={open===true?'hidden':'hover:bg-[#A8A4FF] bg-[#635FC7] z-50 cursor-pointer absolute bottom-0 mb-24 rounded-r-full w-14'} onClick={handleOpen}>
     <button className='pl-4 pr-2 py-3 text-white cursor-pointer' >
    ...
    <div className={open===true?'bg-[#2B2C37] z-50 flex justify-between flex-col absolute w-72 h-screen  border-r-[1px] border-r-[#3E3F4E]':'hidden'}>
      <div>
     ...
     <div className='hover:bg-[#A8A4FF]   rounded-r-full w-64' onClick={()=>handleChange(data)}>
...
<button onClick={()=>dispatch(openCreateBoard(true))} className='  flex justify-center text-lg items-center hover:text-[#A8A4FF]   text-[#635FC7]  tracking-wide font-bold mt-4 text-md px-8 py-3'>
<svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M0 2.889A2.889 2.889 0 0 1 2.889 0H13.11A2.889 2.889 0 0 1 16 2.889V13.11A2.888 2.888 0 0 1 13.111 16H2.89A2.889 2.889 0 0 1 0 13.111V2.89Zm1.333 5.555v4.667c0 .859.697 1.556 1.556 1.556h6.889V8.444H1.333Zm8.445-1.333V1.333h-6.89A1.556 1.556 0 0 0 1.334 2.89V7.11h8.445Zm4.889-1.333H11.11v4.444h3.556V5.778Zm0 5.778H11.11v3.11h2a1.556 1.556 0 0 0 1.556-1.555v-1.555Zm0-7.112V2.89a1.555 1.555 0 0 0-1.556-1.556h-2v3.111h3.556Z" fill="currentColor"></path></svg>
<h1 className='ml-2'>+ Createnew Board</h1>
     ...
     <div className='mb-32'>
     <button onClick={()=>dispatch(openNavbar(false))}  className='  flex justify-center text-lg items-center hover:text-[#A8A4FF]   text-[#828fa3]  tracking-wide font-bold mt-4 text-md px-8 py-3'>
