            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="bg-[#2B2C37] px-5 pt-5 pb-4 sm:p-6 sm:pb-4">
                  ...
                  <div>
                    <p className="text-[#828fa3] text-md leading-relaxed mt-5">Are you sure you want to delete the 'Write launch article to publish on multiple channels' board? 
                  ...
                  <button className="py-2 px-12 hover:opacity-50 bg-[#F0EFFA]  text-[#635FC7] text-lg font-bold rounded-3xl " onClick={()=>dispatch(CardDelete(false))}>Cancel</button>
                  </div>
                </div>
              </Dialog.Panel>
            </Transition.Child>
